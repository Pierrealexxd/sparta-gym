...
@section('subtitulo', 'Marcaciones laborales de los entrenadores — manuales y por QR')
...
@section('contenido')
    ...
    <x-calendario ruta="admin.asistencia.personal" :anterior="$anterior" :siguiente="$siguiente"
