...
@section('contenido')
    <div class="chat" x-data="chat({{ Js::from($conversaciones) }})"
        ...
        {{-- Columna izquierda: lista de hilos + directorio --}}
        <aside class="chat__panel" x-cloak>
            <div class="chat__pestanas" role="tablist">
                <button type="button" role="tab" :aria-selected="pestaña === 'chats'" :class="{ 'is-activo': pestaña === 'chats' }"
                        @click="pestaña = 'chats'">Chats</button>
                <button type="button" role="tab" :aria-selected="pestaña === 'directorio'" :class="{ 'is-activo': pestaña === 'directorio' }"
                        @click="pestaña = 'directorio'; cargarDirectorio()">Nuevo</button>
            </div>

            {{-- Chats --}}
            <div x-show="pestaña === 'chats'" class="chat__cuerpo-lista">
                <div class="chat__lista" x-ref="lista">
                    ...
                    <p class="chat__vacio-lista" x-show="conversaciones.length === 0">
                        Sin conversaciones todavía. Abre el directorio y escribe a alguien.
                    </p>
                </div>
            </div>

            {{-- Directorio --}}
            <div x-show="pestaña === 'directorio'" class="chat__cuerpo-lista">
