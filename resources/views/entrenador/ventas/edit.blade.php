...
<div class="panel__toolbar">
    <a class="btn btn--vidrio" href="{{ route('entrenador.ventas.index', ['tipo' => 'producto']) }}">
        <x-icono nombre="atras" /> Volver a productos
    </a>
</div>
...
<div class="tarjeta">
    ...
    <form method="POST" action="{{ route('ventas.update', $venta) }}">
        ...
        <div class="formulario-panel__acciones">
            ...
            <a class="btn btn--desnudo" href="{{ route('entrenador.ventas.index', ['tipo' => 'producto']) })">Cancelar</a>
        </div>
    </form>
</div>
@endsection