...
class TrainerController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // viendo "Todas las sedes" se podía crear un entrenador con gym_id
        // nulo (users.gym_id sí admite NULL), que después rompía cualquier
        // cosa que sí lo necesite obligatorio — como abrir una conversación
        // con él (ver MensajeController::conversar, el bug original
        // reportado). Un entrenador pertenece a una sede física real.
        if ($bloqueo = $this->exigirSedeEspecifica('un entrenador')) {
            return $bloqueo;
        }
